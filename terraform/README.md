...
|------|-------------|------|---------|:--------:|
| <a name="input_anthropic_key"></a> [anthropic\_key](#input\_anthropic\_key) | Meh | `string` | n/a | yes |
...
| <a name="input_gemini_key"></a> [gemini\_key](#input\_gemini\_key) | Meh | `string` | n/a | yes |
| <a name="input_litelllm_masterkey"></a> [litelllm\_masterkey](#input\_litelllm\_masterkey) | Meh | `string` | n/a | yes |
| <a name="input_name"></a> [name](#input\_name) | The name of the cluster | `string` | `"ai-cluster"` | no |
...
| <a name="input_openapi_key"></a> [openapi\_key](#input\_openapi\_key) | Meh | `string` | n/a | yes |
...
| <a name="input_zone_name"></a> [zone\_name](#input\_zone\_name) | The name of the Route 53 zone | `string` | `"apple.banana.miaou"` | no |
