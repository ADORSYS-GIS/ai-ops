...
variable "sandbox_ec2_instance_types" {
  type = list(string)
}

variable "sandbox_min_instance" {
  type    = number
  default = 1
}

variable "sandbox_max_instance" {
  type    = number
  default = 3
}

variable "sandbox_desired_instance" {
  type    = number
  default = 2
}
